  ...
  <el-container class="main-container">
    ...
    <el-header>
      ...
      >
        ...
        <el-menu-item index="2" @click="tuichu"
    ...
    <el-container>
      ...
      <el-aside width="200px">
        ...
        <el-menu
          ...
          router
        >
        <template v-for="(item,idnex) in menus">
          <el-menu-item v-if="!item.children" :index="item.indexPath" :key="item.indexPath">
            <i :class="item.icon"></i>
            <span>{{item.title}}</span>
          </el-menu-item>

          <el-submenu v-else :index="item.indexPath" :key="idnex">
            <template slot="title">
              <i :class="item.icon"></i>
              <span>{{item.title}}</span>
            </template>
...
<script>
import { getMenuListFn } from '@/api'

export default {
  name: 'my-layout',
  async created () {
    const res = await getMenuListFn()
